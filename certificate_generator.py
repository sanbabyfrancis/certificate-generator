...
print("The participant names are read from an excel file. Make sure that the python script,     ")
print("certificate template (pdf), participant list (xls, xlsx, xlsm, xlsb, odf, odt)           ")
print("and the font (ttf) used to print the name are in the same directory.                   \n")
print("--------------------------\n")

certemplate = input("> Enter the name of the certificate template (eg. template.pdf): ")
excelfile = input("> Enter the name of the excel file that contains participant details (eg. participants.xlsx): ")
